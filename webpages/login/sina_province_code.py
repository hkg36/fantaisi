...
code={"provinces":[{"id":11,"name":"北京","citys":[{"1":"东城区"},{"2":"西城区"},{"3":"崇文区"},{"4":"宣武区"},{"5":"朝阳区"},{"6":"丰台区"},{"7":"石景山区"},{"8":"海淀区"},{"9":"门头沟区"},{"11":"房山区"},{"12":"通州区"},{"13":"顺义区"},{"14":"昌平区"},{"15":"大兴区"},{"16":"怀柔区"},{"17":"平谷区"},{"28":"密云县"},{"29":"延庆县"}]},
...
def PrepareCodeList():
    if len(provs)>0:
        return
    provinces=code["provinces"]
    for one in provinces:
        provs[one["id"]]=one["name"]
        for two in one["citys"]:
            citys[(one["id"],int(two.keys()[0]))]=two.values()[0]
